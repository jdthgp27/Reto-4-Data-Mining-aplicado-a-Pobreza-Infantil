cd ~/Documents/curso5BI/reto4_pobreza_infantil

# Hacer backup
cp README.md README.md.bak

# Regenerar con printf (garantiza saltos de línea)
printf '%s\n' \
...
'## 📊 Dataset' \
'' \
'**Fuente:** [world-bank-unicef-data](https://github.com/danribes/world-bank-unicef-data)' \
...
'![Clusters](reports/figures/clustering_pca_comparativa.png)' \
'' \
...
'' \
'1. **R1 - Países con desarrollo relativo:** Programas de prevención temprana' \
'2. **R2 - Países en situación crítica:** Intervención humanitaria integral' \
'3. **R3 - Sistema de alerta temprana:** Basado en `PIB bajo + pobreza alta`' \
'4. **R4 - Optimización presupuestaria:** Priorizar desarrollo económico' \
'5. **R5 - Monitoreo continuo:** Pipeline predictivo anual' \
'' \
'📄 Detalles en [`reports/final/Recomendaciones_Reto4_jdthg.pdf`](reports/final/)' \
'' \
'---' \
'' \
...
'- [Odisea Data](https://fundae.es) - Programa de formación' \
> README.md

echo "[OK] README.md regenerado con printf"