...
echo "[OK] Parte 1 creada"

cat >> README.md << 'PARTE2'
...
echo "[OK] Parte 2 (estructura) añadida"

cat >> README.md << 'PARTE3'
...
2️⃣ Clustering
Segmentación con K-means, DBSCAN y jerárquico.
